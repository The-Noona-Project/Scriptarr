...
- Preserve Raven title/chapter WebP ingest fields. Reader targets should only choose chapters whose ingest status is
  ready, because CBZ-only chapters are not readable.
